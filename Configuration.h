...
#define STRING_CONFIG_H_AUTHOR "(Patryk Martyniak)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Martyniac 3D printer"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 15, -62, 0 }
